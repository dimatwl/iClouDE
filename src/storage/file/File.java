...
public class File extends ProjectItem {

	public File(String name, String projectKey, String parentKey,
			Date creationTime) {
	 ...
	 */
	public FileWriter openForWriting() throws DatabaseException {
		if (fileExists()) {
			clearFile();
		}
		...
		return new FileWriter(writeChannel, file, this);
	}
